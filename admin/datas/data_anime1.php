        ...
        <div id="content-wrapper" class="d-flex flex-column bg-gradient-light">
            ...
            <div id="content">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../assets/img/img.jpg"
                                            alt="...">
                ...
                <h4 style="text-align: center;">TABEL RILIS ANIME</h4>
                <div class="card shadow mb-4">
                     <div class="card-body">
                     <a href="<?php echo $base_url ?>/data-tambah1" class="btn btn-info" role="button">Tambah Jadwal Rilis</a><br><br>
        ...
        <tbody>
            ...
            $data_anime1 = mysqli_query($kon, "select * from jadwal_rilis");
            while($row = mysqli_fetch_array($data_anime1))
            {
                echo "<tr>
