...
if (isset($_GET['id']))
{
    ...
    mysqli_query($kon,"delete from data_anime where id_anime='$id_delete'");
    ...
    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <h4 style="text-align: center;">TABEL DATA INFO ANIME</h4>
        ...
        <tbody>
            <?php
            include '../inc/connect.php';
            $data_anime = mysqli_query($kon, "select * from data_anime");
            while($row = mysqli_fetch_array($data_anime))
            {
            ?>
                <tr>
                <td><?php
                        if (!empty($row['foto_anime']))
                            {
                             $foto_anime = $row['foto_anime'];
                             echo  "<image height='95px' width='95px' src='".$base_url."/assets/image/".$foto_anime."'> </image>";
                             }
                            else 
                             {
                             echo  "<image height='95px' width='95px' src='".$base_url."/assets/image/noimage.png'; ?> </image>";
                ...
                <td><?php echo $row['total_episode']; ?></td>
                <td><?php echo $row['status_anime']; ?></td>
