...
<div id="content">
    ...
    <div class="container-fluid">
                ...
                <div class="card w-50 p-4" >
                     ...
                     <div class="card-body">
                     <h5 style="text-align: center;">Tambah Jadwal Rilis</h5>
                     <br>
                     <form action="<?php echo $base_url; ?>/datas/action_tambah1.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                            <input type="text" name="waktu_rilis" class="form-control" placeholder="waktu rilis" autofocus required>
                            </div>
                        </div>
