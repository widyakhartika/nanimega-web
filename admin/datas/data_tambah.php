...
<div id="content">
    ...
    <div class="container-fluid">
                ...
                <div class="card w-50 p-4" >
                     ...
                     <div class="card-body">
                     <h5 style="text-align: center;">Tambah </h5>
                     <br>
                     <form action="<?php echo $base_url; ?>/datas/action_tambah.php" method="POST" enctype="multipart/form-data" >
                     
                        <div class="form-row">
                        <div class="col">
                        <input type="text" name="judul_anime" class="form-control" placeholder="Judul anime..." autofocus required>
                        </div>
                        <br>
                        <div class="col">
                        <input type="number" name="tahun_rilis" class="form-control" placeholder="Tahun rilis..." required>
                        </div>
                        </div>
                        <br>
                        <div class="form-row">
                            <div class="col">
                            <input type="text" name="genre" class="form-control" placeholder="Genre..." autofocus required>
                            </div>
                            <br>
                            <div class="col">
                            <input type="text" name="link" class="form-control" placeholder="link" autofocus required>
                            </div>
                            <br>
                            <div class="col">
                            <input type="number" name="total_episode" class="form-control" placeholder="Total episode..." autofocus required>
                            </div>

                            <div class="col">
                            <input type="text" name="status_anime" class="form-control" placeholder="Status anime..." autofocus required>
                            </div>
                            ...
                            <textarea name="deskripsi"  rows="10" cols="53" class="form-control"></textarea>
                            </div>
                            <br>
                            <br>
                            <div class="col">
                                <label for="foto_barang">Masukan Foto Anime (jika ada)</label>
                                    <br>
                                <input class="form-control-file" type="file" name="foto_anime" accept="image/png, image/jpeg" onchange="loadFile(event)" required />
                            </div>
                        ...
                        <br>
                        <button type="submit" name="ajukan" class="btn btn-info">Tambah Data</button>
                        <br>
